...
import net.thumbtack.school.old.colors.ColorErrorCode;
...
public class TestRectangle3D {
    ...
    public void testIsPointInsideRectangle3D3() throws ColorException {
        ...
        assertTrue(rect3D.isInside(10, 40, 0));
        assertFalse(rect3D.isInside(10, 20,11));
        assertFalse(rect3D.isInside(10, 100,0));
        assertFalse(rect3D.isInside(-10, 20,4));
        assertFalse(rect3D.isInside(10, -20,20));
    }

    @Test
    public void testIsPointInsideRectangle3D4() throws ColorException {
        Rectangle3D rect3D = new Rectangle3D(10, 20, 30, 40, 10, Color.BLUE);
        ...
        assertTrue(rect3D.isInside(new Point3D(10, 40,0)));
        assertFalse(rect3D.isInside(new Point3D(10, 40,11)));
        assertFalse(rect3D.isInside(new Point3D(10, 100,10)));
        assertFalse(rect3D.isInside(new Point3D(-10, 20,20)));
        assertFalse(rect3D.isInside(new Point3D(10, -20,5)));
    }
    ...
    public void testSetHeightRectangle3D() throws ColorException {
        Rectangle3D rect3D = new Rectangle3D(10, 20, 30, 40, 10, Color.BLUE);
        rect3D.setHeight(150);
        assertEquals(150,rect3D.getHeight());
    }
