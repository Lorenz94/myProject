...
public class TestFigure {
    ...
    public void testIsInside1() throws ColorException {
        ...
        for (Figure figure : figures)
            assertTrue(figure.isInside(point));
    }
    ...
    @Test
    public void testIsInside3() throws ColorException {
        Figure[] figures = new Figure[3];
        figures[0] = new Circle(0, 0, 10, Color.BLUE);
        figures[1] = new Rectangle(-10, -20, 10, 20, Color.BLUE);
        Point2D point1 = new Point2D(2, 0);
    ...
    @Test
    public void testGetColorFigure() throws ColorException {
        Figure[] figures = new Figure[3];

        figures[0] = new Circle(0,0,1,Color.BLUE);
        figures[1] = new Rectangle(0,0,1,1,"BLUE");
        Point2D point1 = new Point2D(2, 0);
        Point2D point2 = new Point2D(-1, 0);
        Point2D point3 = new Point2D(0, 2);
        figures[2] = new Triangle(point1,point2,point3,"BLUE");
        for (Figure figure : figures) {
            assertEquals(Color.BLUE, figure.getColor());
        }
    }
